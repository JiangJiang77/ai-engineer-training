...
from smart_customer_service_extend.repository import query_orders, update_order_status
...
def get_order_logistics(order_id: str) -> str:
    ...
    try:
        from smart_customer_service_extend.repository import get_order_by_id
...
def issue_invoice(order_id: str) -> str:
    ...
    try:
        from smart_customer_service_extend.repository import get_order_by_id, update_order_invoice_status
