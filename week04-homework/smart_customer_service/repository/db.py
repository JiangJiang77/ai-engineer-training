...
def load_mock_data():
    ...
    from smart_customer_service.repository.session_repo import create_user, get_user_by_username
    from smart_customer_service.repository.order_repo import create_order
