...
from smart_customer_service.api.models import ChatRequest, ChatResponse
from smart_customer_service.config import settings
from smart_customer_service.server import api_service
...
async def websocket_endpoint(
    websocket: WebSocket, session_id: str, user_id: str = "test_user"
):
    """WebSocket 对话接口"""
