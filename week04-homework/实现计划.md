...
#### [NEW] [settings.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/config/settings.py)
...
#### [NEW] [graph.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/workflow/graph.py)
...
#### [NEW] [nodes.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/workflow/nodes.py)
...
#### [NEW] [order_tools.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/tools/order_tools.py)
...
#### [NEW] [multimodal_tools.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/tools/multimodal_tools.py)
...
#### [NEW] [models.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/database/models.py)
...
#### [NEW] [crud.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/database/crud.py)
...
#### [NEW] [hot_reload.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/core/hot_reload.py)
...
#### [NEW] [gradio_app.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/ui/gradio_app.py)
...
#### [MODIFY] [main.py](file:///Users/culiang/Documents/GitHub/ai-engineer-training/week04-homework/smart_customer_service_extend/main.py)
...
2. **初始化数据表**:
   ```bash
   python -m smart_customer_service_extend.database.init_db
   ```
...
3. **插入模拟订单数据**:
   ```bash
   python -m smart_customer_service_extend.database.init_db --load-mock-data
   ```
...
# 4. 运行系统
python -m smart_customer_service_extend.main
```
...
# 测试阿里云连接
python -c "from smart_customer_service_extend.tools.multimodal_tools import test_aliyun_connection; test_aliyun_connection()"
```
