...
def extract_order_id(user_input):
    ...
    match = re.search(r"ORD\d{8}", user_input)
...
def get_order_details(order_id):
    ...
    # 模拟一个已收货的普通商品订单
    return Order(status="delivered", category="physical")
...
if __name__ == "__main__":
    # 示例运行
    test_input = "我要退款，订单号是 ORD12345678"
    result = handle_refund_request(test_input, {})
