...
if __name__ == "__main__":
    print("=== DSL 常见应用场景 ===")
    scenarios = [
        "1. 客服流程编排 (Workflow DSL)",
        "2. 风控审批流程 (Decision Rules Engine)",
        "3. 多Agent协作调度 (Multi-Agent Orchestration)",
        "4. 智能体配置 (RAG/Agent Configuration)",
        "5. 业务逻辑集成 (System Integration Flow)",
    ]
    for scenario in scenarios:
        print(scenario)
    print("\n注：该脚本主要展示了不同领域中 DSL 的设计示例（见代码注释）。")
